function [U_final, V_final, nIter_final, objhistory_final] =CDCF(X,E,k, W, options, U, V)
% Class Driven Concept Factorization (CDCF)  2015.7.23
%
% where
%   X
% Notation:
...
% E.....A class-driven label indication matrix
...
switch lower(options.Optimization)
    case {lower('Multiplicative')} 
        [U_final, V_final, nIter_final, objhistory_final] = CDCF_Multi(X, E, k, W, options, U, V);
    otherwise
