function [U_final, Z_final, F_final, nIter_final, obj_all] = LpCNMF_wo_Lp(X, A, r, k, S, W, options, U, Z, F)
    ...
    switch lower(options.Optimization)
        case {lower('Multiplicative')} 
            [U_final, Z_final, F_final, nIter_final, obj_all] = LpCNMF_wo_Lp_Multi(X, A, r, k, S, W, options, U, Z, F);
        otherwise
