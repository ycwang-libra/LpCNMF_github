function [U_final, Z_final, nIter_final, objhistory_final] = CNMF(X, A, k, W, options, U, V)
% Graph regularized Non-negative Matrix Factorization (GNMF)  2014.11.25
%
% where
%   X
% Notation:
...
switch lower(options.Optimization)
    case {lower('Multiplicative')} 
        [U_final, Z_final, nIter_final, objhistory_final] = CNMF_Multi(X,A, k,W, options, U, V);
    otherwise
