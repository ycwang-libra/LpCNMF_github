function [U_final, V_final, nIter_final, objhistory_final] = CDCF_Multi(X,E, k, W, options, U, V)
% Class Driven Concept Factorization (CDCF) with
...
meanFitRatio = options.meanFitRatio;   %0.1
...
if nRepeat == 1
    ...
    minIter = 0;
    if isempty(maxIter)
        objhistory = CalculateObj(X, X*U, V, L);
